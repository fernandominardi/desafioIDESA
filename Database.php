...
class Database
{
    ...
    public static function setDB(): void
    {
        ...
        // Nota: las siguientes fechas se modificaron para realizar pruebas del Desafío 1.
        $db->exec("INSERT INTO debts(id, lote, precio, clientID, vencimiento) VALUES (6,'00148',190000,123456, '2025-12-01')");
        $db->exec("INSERT INTO debts(id, lote, precio, clientID, vencimiento) VALUES (7,'00148',190000,123456, '2025-01-01')");
        $db->exec("INSERT INTO debts(id, lote, precio, clientID, vencimiento) VALUES (8,'00148',190000,123456, '2025-02-01')");
    }
